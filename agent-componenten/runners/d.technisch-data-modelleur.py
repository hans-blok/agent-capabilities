...
class TechnischDataModelleurAgent:
    ...
    def __init__(self, args):
        ...
        self.charter_path = Path("c:\gitrepo\standard\charters.agents\std.agent.charter.d.technisch-data-modelleur.md")
    ...
    def run(self) -> Dict:
        ...
        try:
            ...
            # Dit zou typisch een LLM call zijn met de prompt uit C:\gitrepo\agent-capabilities\scripts-agent-ecosysteem\agent-componenten\prompts\d.technisch-data-modelleur.prompt.md
...
- Prompt: C:\gitrepo\agent-capabilities\scripts-agent-ecosysteem\agent-componenten\prompts\d.technisch-data-modelleur.prompt.md
- Input bestanden
"""
