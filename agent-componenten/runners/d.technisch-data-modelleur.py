...
Agent: std.d.technisch-data-modelleur
Fase: d
Charter: C:\gitrepo\standard\artefacten\3-charters-agents\std.agent.charter.d.technisch-data-modelleur.md
...
class TechnischDataModelleurAgent:
    ...
    def __init__(self, args):
        ...
        self.charter_path = Path("C:\gitrepo\standard\artefacten\3-charters-agents\std.agent.charter.d.technisch-data-modelleur.md")
