...
class LayoutOptimizerAgent:
    ...
    def run(self) -> Dict:
        ...
        try:
            ...
            # Dit zou typisch een LLM call zijn met de prompt uit C:\gitrepo\agent-capabilities\agent-componenten\prompts\u.layout-optimizer.prompt.md
...
- Prompt: C:\gitrepo\agent-capabilities\agent-componenten\prompts\u.layout-optimizer.prompt.md
- Input bestanden
"""
