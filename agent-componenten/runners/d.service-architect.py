...
Agent: std.d.service-architect
Fase: d
Charter: C:\gitrepo\standard\artefacten\3-charters-agents\std.agent.charter.d.service-architect.md
...
class ServiceArchitectAgent:
    ...
    def __init__(self, args):
        ...
        self.charter_path = Path("C:\gitrepo\standard\artefacten\3-charters-agents\std.agent.charter.d.service-architect.md")
