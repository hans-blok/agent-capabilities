...
class ServiceArchitectAgent:
    ...
    def __init__(self, args):
        ...
        self.charter_path = Path("c:\gitrepo\standard\charters.agents\std.agent.charter.d.service-architect.md")
    ...
    def run(self) -> Dict:
        ...
        try:
            ...
            # Dit zou typisch een LLM call zijn met de prompt uit C:\gitrepo\agent-capabilities\scripts-agent-ecosysteem\agent-componenten\prompts\d.service-architect.prompt.md
...
- Prompt: C:\gitrepo\agent-capabilities\scripts-agent-ecosysteem\agent-componenten\prompts\d.service-architect.prompt.md
- Input bestanden
"""
