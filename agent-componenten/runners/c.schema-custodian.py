...
Agent: std.c.schema-custodian
Fase: c
Charter: c:\gitrepo\standard\charters.agents\std.agent.charter.c.schema-custodian.md
...
class SchemaCustodianAgent:
    ...
    def __init__(self, args):
        ...
        self.charter_path = Path("c:\gitrepo\standard\charters.agents\std.agent.charter.c.schema-custodian.md")
    ...
    def run(self) -> Dict:
        ...
        try:
            ...
            # Dit zou typisch een LLM call zijn met de prompt uit C:\gitrepo\agent-capabilities\scripts-agent-ecosysteem\agent-componenten\prompts\c.schema-custodian.prompt.md
...
- Prompt: C:\gitrepo\agent-capabilities\scripts-agent-ecosysteem\agent-componenten\prompts\c.schema-custodian.prompt.md
- Input bestanden
"""
