...
Fase: c
Charter: C:\gitrepo\standard\artefacten\3-charters-agents\std.agent.charter.c.schema-custodian.md
...
class SchemaCustodianAgent:
    ...
    def __init__(self, args):
        ...
        self.charter_path = Path("C:\gitrepo\standard\artefacten\3-charters-agents\std.agent.charter.c.schema-custodian.md")
