...
Runner script voor founding-hypothesis-owner agent.

Agent: std.a.founding-hypothesis-owner
Fase: a
Charter: c:\gitrepo\standard\charters.agents\std.agent.charter.a.founding-hypothesis-owner.md
...
class FoundingHypothesisOwnerAgent:
    """Agent implementation for founding-hypothesis-owner."""
    
    def __init__(self, args):
        """Initialize the agent."""
        self.args = args
        self.output_root = Path("<project-workspace>/artefacten")
        self.charter_path = Path("c:\gitrepo\standard\charters.agents\std.agent.charter.a.founding-hypothesis-owner.md")
    ...
    def run(self) -> Dict:
        ...
        try:
            ...
            # Dit zou typisch een LLM call zijn met de prompt uit C:\gitrepo\agent-capabilities\scripts-agent-ecosysteem\agent-componenten\prompts\a.founding-hypothesis-owner.prompt.md
...
- Prompt: C:\gitrepo\agent-capabilities\scripts-agent-ecosysteem\agent-componenten\prompts\a.founding-hypothesis-owner.prompt.md
- Input bestanden
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Runner voor founding-hypothesis-owner agent',
    ...
    agent = FoundingHypothesisOwnerAgent(args)
    result = agent.run()
