...
Fase: a
Charter: C:\gitrepo\standard\artefacten\3-charters-agents\std.agent.charter.a.founding-hypothesis-owner.md
...
class FoundingHypothesisOwnerAgent:
    ...
    def __init__(self, args):
        ...
        self.charter_path = Path("C:\gitrepo\standard\artefacten\3-charters-agents\std.agent.charter.a.founding-hypothesis-owner.md")
