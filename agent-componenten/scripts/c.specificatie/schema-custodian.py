...
Agent: std.c.specificatie.schema-custodian
Fase: c.specificatie
...
class SchemaCustodianAgent:
    ...
    def __init__(self, args):
        ...
        self.args = args
        self.output_root = Path("C:\gitrepo\agent-capabilities\artefacten\c.specificatie")
        self.charter_path = Path("C:\gitrepo\standard\charters.agents\c.specificatie\std.agent.charter.c.schema-custodian.md")
    ...
    def run(self) -> Dict:
        ...
        try:
            ...
            # Dit zou typisch een LLM call zijn met de prompt uit C:\gitrepo\agent-capabilities\.github\prompts\c.schema-custodian.prompt.md
...
- Prompt: C:\gitrepo\agent-capabilities\.github\prompts\c.schema-custodian.prompt.md
- Input bestanden
"""
