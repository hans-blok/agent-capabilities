...
Agent: std.c.specificatie.logisch-data-modelleur
Fase: c.specificatie
...
class LogischDataModelleurAgent:
    ...
    def __init__(self, args):
        ...
        self.charter_path = Path("C:\gitrepo\standard\charters.agents\c.specificatie\std.agent.charter.c.logisch-data-modelleur.md")
    ...
    def run(self) -> Dict:
        ...
        try:
            ...
            # Dit zou typisch een LLM call zijn met de prompt uit C:\gitrepo\agent-capabilities\.github\prompts\c.logisch-data-modelleur.prompt.md
...
- Prompt: C:\gitrepo\agent-capabilities\.github\prompts\c.logisch-data-modelleur.prompt.md
- Input bestanden
"""
