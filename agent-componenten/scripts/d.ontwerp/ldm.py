...
Runner script voor ldm agent.

Agent: std.d.ontwerp.ldm
Fase: d.ontwerp
Charter: C:\gitrepo\standard\charters.agents\d.ontwerp\std.agent.charter.d.ldm.md
...
class LdmAgent:
    """Agent implementation for ldm."""
    
    def __init__(self, args):
        """Initialize the agent."""
        self.args = args
        self.output_root = Path("C:\gitrepo\agent-capabilities\artefacten\d.ontwerp")
        self.charter_path = Path("C:\gitrepo\standard\charters.agents\d.ontwerp\std.agent.charter.d.ldm.md")
    ...
    def run(self) -> Dict:
        ...
        try:
            ...
            # Dit zou typisch een LLM call zijn met de prompt uit C:\gitrepo\agent-capabilities\prompts\d.ontwerp\ldm.prompt.md
...
- Prompt: C:\gitrepo\agent-capabilities\prompts\d.ontwerp\ldm.prompt.md
- Input bestanden
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Runner voor ldm agent',
