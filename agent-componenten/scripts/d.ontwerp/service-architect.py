...
Agent: std.d.ontwerp.service-architect
Fase: d.ontwerp
...
class ServiceArchitectAgent:
    ...
    def __init__(self, args):
        ...
        self.charter_path = Path("C:\gitrepo\standard\charters.agents\d.ontwerp\std.agent.charter.d.service-architect.md")
    ...
    def run(self) -> Dict:
        ...
        try:
            ...
            # Dit zou typisch een LLM call zijn met de prompt uit C:\gitrepo\agent-capabilities\.github\prompts\d.service-architect.prompt.md
...
- Prompt: C:\gitrepo\agent-capabilities\.github\prompts\d.service-architect.prompt.md
- Input bestanden
"""
