...
Agent: std.d.ontwerp.technisch-data-modelleur
Fase: d.ontwerp
...
class TechnischDataModelleurAgent:
    ...
    def __init__(self, args):
        ...
        self.args = args
        self.output_root = Path("C:\gitrepo\agent-capabilities\artefacten\d.ontwerp")
        self.charter_path = Path("C:\gitrepo\standard\charters.agents\d.ontwerp\std.agent.charter.d.technisch-data-modelleur.md")
    ...
    def run(self) -> Dict:
        ...
        try:
            ...
            # Dit zou typisch een LLM call zijn met de prompt uit C:\gitrepo\agent-capabilities\.github\prompts\d.technisch-data-modelleur.prompt.md
...
- Prompt: C:\gitrepo\agent-capabilities\.github\prompts\d.technisch-data-modelleur.prompt.md
- Input bestanden
"""
