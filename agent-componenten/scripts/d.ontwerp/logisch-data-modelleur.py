...
Agent: std.d.ontwerp.logisch-data-modelleur
Fase: d.ontwerp
...
class LogischDataModelleurAgent:
    ...
    def __init__(self, args):
        ...
        self.charter_path = Path("C:\gitrepo\standard\charters.agents\d.ontwerp\std.agent.charter.d.logisch-data-modelleur.md")
    ...
    def run(self) -> Dict:
        ...
        try:
            ...
            # Dit zou typisch een LLM call zijn met de prompt uit C:\gitrepo\agent-capabilities\.github\prompts\d.logisch-data-modelleur.prompt.md
...
- Prompt: C:\gitrepo\agent-capabilities\.github\prompts\d.logisch-data-modelleur.prompt.md
- Input bestanden
"""
