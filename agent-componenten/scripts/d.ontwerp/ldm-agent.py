...
Runner script voor ldm-agent agent.

Agent: std.d.ontwerp.ldm-agent
Fase: d.ontwerp
Charter: C:\gitrepo\standard\charters.agents\d.ontwerp\std.agent.charter.d.ldm-agent.md
Gegenereerd: 2026-01-05
"""
...
class LdmAgentAgent:
    """Agent implementation for ldm-agent."""
    
    def __init__(self, args):
        """Initialize the agent."""
        self.args = args
        self.output_root = Path("C:\gitrepo\agent-capabilities\artefacten\d.ontwerp")
        self.charter_path = Path("C:\gitrepo\standard\charters.agents\d.ontwerp\std.agent.charter.d.ldm-agent.md")
    ...
    def run(self) -> Dict:
        ...
        try:
            ...
            # Dit zou typisch een LLM call zijn met de prompt uit C:\gitrepo\agent-capabilities\prompts\d.ontwerp\ldm-agent.prompt.md
...
- Prompt: C:\gitrepo\agent-capabilities\prompts\d.ontwerp\ldm-agent.prompt.md
- Input bestanden
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Runner voor ldm-agent agent',
