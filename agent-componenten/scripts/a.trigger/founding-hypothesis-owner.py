...
class FoundingHypothesisOwnerAgent:
    ...
    def __init__(self, args):
        ...
        self.args = args
        self.output_root = Path("C:\gitrepo\agent-capabilities\artefacten\a.trigger")
        self.charter_path = Path("C:\gitrepo\standard\charters.agents\a.trigger\std.agent.charter.a.founding-hypothesis-owner.md")
    ...
    def run(self) -> Dict:
        ...
        try:
            ...
            # Dit zou typisch een LLM call zijn met de prompt uit C:\gitrepo\agent-capabilities\.github\prompts\a.founding-hypothesis-owner.prompt.md
...
- Prompt: C:\gitrepo\agent-capabilities\.github\prompts\a.founding-hypothesis-owner.prompt.md
- Input bestanden
"""
