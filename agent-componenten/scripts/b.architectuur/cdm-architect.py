...
Runner script voor cdm-architect agent.

Agent: std.b.architectuur.cdm-architect
Fase: b.architectuur
...
class CdmArchitectAgent:
    """Agent implementation for cdm-architect."""
    
    def __init__(self, args):
        """Initialize the agent."""
        self.args = args
        self.output_root = Path("C:\gitrepo\agent-capabilities\artefacten\b.architectuur")
        self.charter_path = Path("C:\gitrepo\standard\charters.agents\b.architectuur\std.agent.charter.b.cdm-architect.md")
    ...
    def run(self) -> Dict:
        ...
        try:
            ...
            # Dit zou typisch een LLM call zijn met de prompt uit C:\gitrepo\agent-capabilities\.github\prompts\b.cdm-architect.prompt.md
...
- Prompt: C:\gitrepo\agent-capabilities\.github\prompts\b.cdm-architect.prompt.md
- Input bestanden
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Runner voor cdm-architect agent',
